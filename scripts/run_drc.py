...
Exit Codes:
    0 - Success (DRC passed)
    1 - DRC failed or tool execution error
...
def main():
    ...
    # Parse arguments
    if len(sys.argv) < 3:
        print("Usage: python run_drc.py <lib> <cell> [view] [tech_node]")
        print("\nArguments:")
        ...
        print("\nExample:")
        print("  python run_drc.py MyLib MyCell layout T28")
        sys.exit(2)
